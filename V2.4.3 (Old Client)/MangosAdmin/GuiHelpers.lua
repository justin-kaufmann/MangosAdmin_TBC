...
-- Content zurücksetzen und neuen Container erzeugen
...
function MangosAdmin.CreateEdit(parent, x, y, labelText, width)
  ...
  -- Tab springt zum nächsten Eingabefeld (optional)
  edit:SetScript("OnTabPressed", function(self)
    self:ClearFocus()
    -- Optional: könnte hier Fokus auf nächstes Eingabefeld gesetzt werden
  end)
