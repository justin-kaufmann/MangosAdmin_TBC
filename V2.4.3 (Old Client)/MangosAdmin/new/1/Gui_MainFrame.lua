...
if MangosAdmin.CreateStatusLabel then
  MangosAdmin.CreateStatusLabel(f)
end

-- Speichere UI-Referenzen
...
if MangosAdmin.CreateScrollArea then
  MangosAdmin.CreateScrollArea(panel, 10) -- innerPadding = 10 (wie original)
end

-- Kategorien-Buttons und Initialladung
if MangosAdmin.CreateCategoryButtons then
  MangosAdmin.CreateCategoryButtons()
end

-- Minimap-Button
if MangosAdmin.CreateMinimapButton then
  MangosAdmin.CreateMinimapButton(f)
end